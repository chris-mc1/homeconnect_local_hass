...
COMMON_ENTITY_DESCRIPTIONS: _EntityDescriptionsDefinitionsType = {
    ...
    "sensor": [
        ...
        HCSensorEntityDescription(
            key="sensor_cleaning_robot_battery_level",
            entity="BSH.Common.Status.BatteryLevel",
        ...
        HCSensorEntityDescription(
            key="sensor_cleaning_robot_charging_state",
            entity="BSH.Common.Status.BatteryChargingState",
            device_class=SensorDeviceClass.ENUM,
            has_state_translation=True,
        ),
        generate_door_state,
    ...
    "number": [
        ...
        HCNumberEntityDescription(
            key="number_sound_volume",
            entity="BSH.Common.Setting.Sound.Volume",
            entity_category=EntityCategory.CONFIG,
            native_unit_of_measurement=PERCENTAGE,
            mode=NumberMode.AUTO,
        ),
